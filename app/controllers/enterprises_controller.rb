class EnterprisesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @enterprise.save
        format.html { redirect_to enterprise_url(@enterprise), notice: "Enterprise was successfully created." }
  ...
  def update
    respond_to do |format|
      if @enterprise.update(enterprise_params)
        format.html { redirect_to enterprise_url(@enterprise), notice: "Enterprise was successfully updated." }
