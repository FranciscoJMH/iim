class ProvidersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @provider.save
        format.html { redirect_to provider_url(@provider), notice: "Proveedor creado correctamente." }
  ...
  private
    ...
    def provider_params
      params.require(:provider).permit(:name, :social_reason, :rfc, :telephone, :email)
    end
end
