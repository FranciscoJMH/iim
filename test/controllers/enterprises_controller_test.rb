...
class EnterprisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enterprise" do
    assert_difference("Enterprise.count") do
      post enterprises_url, params: { enterprise: { name: @enterprise.name, responsible_id: @enterprise.responsible_id } }
    end
  ...
  test "should update enterprise" do
    patch enterprise_url(@enterprise), params: { enterprise: { name: @enterprise.name, responsible_id: @enterprise.responsible_id } }
