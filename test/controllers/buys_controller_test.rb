...
class BuysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buy" do
    assert_difference("Buy.count") do
      post buys_url, params: { buy: { iva: @buy.iva, project_id: @buy.project_id, quantity: @buy.quantity, total: @buy.total } }
    end
  ...
  test "should update buy" do
    patch buy_url(@buy), params: { buy: { iva: @buy.iva, project_id: @buy.project_id, quantity: @buy.quantity, total: @buy.total } }
